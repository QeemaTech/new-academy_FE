  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        [
          ...
          'rounded-lg border border-border bg-card shadow-(--shadow-card) outline-none',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute inset-e-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100',
